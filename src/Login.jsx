    ...
    <div className="flex h-screen bg-[#000000] ">
      ...
      <div className="w-full max-w-md p-8 mt-6">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          <p className="text-lg font-bold text-[#ffffff] cursor-pointer">Login</p>
          <p className="text-lg text-gray-400 cursor-pointer ">Signup</p>
        ...
        <form className="space-y-4">
          ...
          <input 
              ...
              className="w-full px-4 py-3 border border-gray-400 rounded-lg bg-[#ffff] text-[#000] text- placeholder-gray-400 focus:outline-none "/>
          ...
          <div className="flex gap-4">
            <button className="flex-1 flex items-center justify-center gap-3 border border-[#4a5565] px-4 py-2 rounded-lg bg-[#000000] text-[#ffffff] hover:bg-gray-900 transition">
              <img src={logos_google} alt="Google" className="w-5 h-5" />
              <p className="text-sm">Google</p>
            </button>

            <button className="flex-1 flex items-center justify-center gap-3 bg-[#1447e6] text-[#ffff] px-4 py-2 rounded-lg hover:bg-blue-900 transition">
